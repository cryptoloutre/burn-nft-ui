...
export const BurnButton: FC<Props> = ({
    ...
    return (
        <div>
            {amount === "1" && !isburning &&
                <button className="btn btn-primary uppercase" onClick={() => { if (publicKey) burnTokenAndCloseAccount(tokenMintAddress, publicKey, wallet, connection, setAmount, setIsburning); else setVisible(true) }}>burn nft</button>
            }
